...
document.addEventListener("DOMContentLoaded", function () {
    if (!localStorage.getItem("adminic_cookie_consent")) {
        ...
        banner.className = "fixed bottom-0 left-0 right-0 z-[9999] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] px-4 py-4 md:px-8 transition-colors duration-300";
        banner.innerHTML = `
